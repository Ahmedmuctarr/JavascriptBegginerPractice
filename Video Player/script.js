class VideoPlayer {
    constructor() {
        ...
        if (!document.getElementById("track_video")) {
            ...
            // Get the element with the class 'left'
            var leftElement = document.querySelector('.left');
            leftElement.insertBefore(this.video,leftElement.firstChild); // Append the video element to the left class element
        } else {
            // Reuse the existing video element
        ...
        this.All_video = [
            {
                name: "Red One",
                path: "videos/Red_one.mkv",
            },
            {
                name: "mufasa",
                path: "videos/mufasa.mkv",
            },
        ];
