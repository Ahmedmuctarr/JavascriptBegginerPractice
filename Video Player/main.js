...
toggleView() {
	...
	const videoListSection = document.querySelector('.video_list');
...
function load_track(index_no){
    ...
    track.load();
	document.title = All_song[index_no].name;
    favicon.href = All_song[index_no].img;
...
function range_slider(){
	let position = 0;
	 ...
	 document.addEventListener('keyup', function(event) {
		// Check if the released key is 'n'
